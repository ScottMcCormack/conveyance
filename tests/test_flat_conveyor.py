...
class TestFlatConveyor(unittest.TestCase):
    ...
    def test_flat_conveyor_design(self):
        ...
        f_n = conveyor_resistances.resistance_secondary(q_v=self.c.q_v, p=self.c.p, v=self.c.v, v_0=self.c.v_0,
        ...
        self.assertAlmostEqual(self.c.f_ba + self.c.f_f + (2 * f_1t), f_n_expected, 2)

        # f_gl: Resistance due to friction between the material handled and skirt plates
        f_gl = conveyor_resistances.resistance_material_skirtplates(q_v=self.c.q_v, p=self.c.p, v=self.c.v, l_s=self.c.l_s, b1=self.c.b1, mu2=self.c.mu2)
        ...
        f_s = conveyor_resistances.resistance_concentrated(q_v=self.c.q_v, p=self.c.p, v=self.c.v, l_s=self.c.l_s, b1=self.c.b1,
        ...
        f_bs_min_o, f_bs_min_u = conveyor_resistances.resistance_belt_sag_tension(q_m=self.c.q_m, q_b=self.c.q_b, a_o=self.c.a_o, a_u=self.c.a_u,
        ...
        f_u = self.c.f_h + f_n + f_s + self.c.f_st
        ...
        # Sum previous components together
        self.assertAlmostEqual(self.c.f_ba + self.c.f_f + f_1t_d + f_1t_t, f_n_expected, 0)
